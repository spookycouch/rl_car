...
from utils.detector import MockDetector
...
class RealEnv(gym.Env):
    ...
    def __init__(
        ...
        self.__shape_detector = MockDetector(
            return_value={2: np.ndarray(0.5,0.5,0.0)}
        )
    ...
    def __get_info(self):
        ...
        detections.update(self.__shape_detector.detect(image))
